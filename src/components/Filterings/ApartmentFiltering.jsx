...
const ApartmentFiltering = () => {
    return (
        <div className={"filtering-type"}>
            ...
            <CustomCheckBox keyData={'blc'} checkBoxLabel="Балкон" typeBox={'and'}
                            buttonsText={["Есть", "Нет", "Лоджи", "Два"]}/>
            ...
            <CustomCheckBox keyData={'flrp'} checkBoxLabel="Ремонт" typeBox={'or'}
                            buttonsText={["Косметический", ["Евро", 5], ["Дизайнерский", 10], ["Строительная отделка", 15], ["Без отделки", 20], ["Аварийное состояние", 25]]}/>
            <CustomCheckBox keyData={'hst'} checkBoxLabel="Материал стен"
...
export default ApartmentFiltering;
